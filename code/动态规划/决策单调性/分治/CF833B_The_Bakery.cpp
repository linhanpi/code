 ...
 * @Date: 2023-02-03 21:52:52 
 * @Last Modified by:   watering_penguin 
 * @Last Modified time: 2023-02-03 21:52:52 
 */
#include<bits/stdc++.h>
...
inline void md(int L,int R){
	while(l>L)--l,w+=!tong[a[l]]++;
	while(l<L)w-=!--tong[a[l]],++l;
	while(r<R)++r,w+=!tong[a[r]]++;
	while(r>R)w-=!--tong[a[r]],--r;
	return ;
}
